...
#
#
@test "one or more png files are actually tiff files cs316" {
  ...
  [ "${lines[0]}" == "simple.error.message=One or more images are not of type png" ]
  echo ":${lines[1]}:"
  [[ "${lines[1]}" == "detailed.error.message=$THE_TMP/bin/command returned these dimensions "* ]]
