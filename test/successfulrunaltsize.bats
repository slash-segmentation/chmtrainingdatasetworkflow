...
#
#
@test "successful run with real copy and alternate size" {
  ...
  run $KEPLER_SH -runwf -redirectgui $THE_TMP -identifyCmd "$THE_TMP/bin/command" -CWS_jobname jname -CWS_user joe -CWS_jobid 123 -imageDimensions 250x250 -inputPathRaw "$THE_TMP/fakewf" -CWS_outputdir $THE_TMP $WF
